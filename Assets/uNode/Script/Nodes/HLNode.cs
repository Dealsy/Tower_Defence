	...
	public class HLNode : ValueNode, IRefreshable {
		...
		public override void OnRuntimeInitialize() {
			...
			if(instanceType != null) {
				if(!ReflectionUtils.CanCreateInstance(instanceType)) {
					return;
				}
		...
		public override void CheckError() {
			base.CheckError();
			if(!ReflectionUtils.CanCreateInstance(type.startType)) {
				uNodeUtility.RegisterEditorError(this, "Cannot create instance of type: " + type.startType);
			}
