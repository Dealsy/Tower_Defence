...
namespace MaxyGames.uNode.Editors {
	public static class RoslynUtility {
		...
		public static List<Syntax> GetSyntaxTreesFromFiles(IEnumerable<string> paths) {
			return GetSyntaxTreesFromFiles(paths, GetPreprocessorSymbols());
		}

		public static List<Syntax> GetSyntaxTreesFromFiles(IEnumerable<string> paths, IEnumerable<string> preprocessorSymbols = null) {
			var result = new List<Syntax>();
		...
		private static CompileResult DoCompileAndLoad(
			...
			try {
				...
				if(scriptPaths != null) {
					List<Syntax> syntaxs = new List<Syntax>();
