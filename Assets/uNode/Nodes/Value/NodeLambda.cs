...
namespace MaxyGames.uNode.Nodes {
	...
	public class NodeLambda : ValueNode {
		...
		public override string GenerateValueCode() {
			...
			if(/*!CG.IsInStateGraph(this) &&*/ CG.CanSimplifyToLambda(methodInfo.ReturnType == typeof(void) ? body : input, methodInfo.ReturnType, paramTypes)) {
				var bodyNode = methodInfo.ReturnType == typeof(void) ? body.GetFlowNode() : input.GetFlowNode();
