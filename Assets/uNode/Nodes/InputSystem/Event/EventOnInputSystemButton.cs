	...
	public class EventOnInputSystemButton : BaseGraphEvent, IExtendedOutput {
		...
		public override void OnGeneratorInitialize() {
			CG.RegisterUserObject(
				new[] {
					CG.RegisterPrivateVariable(CG.GenerateVariableName(nameof(m_Action), this), typeof(InputAction)),
					inputActionChangeType == InputActionOption.OnReleased ? CG.RegisterPrivateVariable(CG.GenerateVariableName(nameof(m_WasRunning), this), typeof(bool)) : "",
				}, 
				this
			);
		}
